# Serpapi Universal MCP Server

This repository contains an implementation of an Serpapi Universal MCP (Model Context Protocol) server. It provides a standardized interface for interacting with Serpapi's SEO and backlink analysis tools through a unified API.
...
You can start using Serpapi directly from [agentr.dev](https://agentr.dev). Visit [agentr.dev/apps](https://agentr.dev/apps) and enable Serpapi.
...
3. **Start the MCP Inspector**
   ...
   ```bash
   mcp dev src/universal_mcp_serpapi/mcp.py
   ```
...
4. **Install the Application**
   ```bash
   mcp install src/universal_mcp_serpapi/mcp.py
   ```
